...
if _platform in {"windows", "win32", "nt"}:
    from pysysinfo.core.windows import WindowsHardwareManager as HardwareManager

    if hasattr(os, "add_dll_directory"):
        os.add_dll_directory(_dll_path)
elif _platform == "darwin":
    from pysysinfo.core.mac import MacHardwareManager as HardwareManager
else:
    # Default to Linux for unknown/override cases (including tests on macOS)
    from pysysinfo.core.linux import LinuxHardwareManager as HardwareManager
